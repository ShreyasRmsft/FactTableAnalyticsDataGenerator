...
namespace db_connect
{
    ...
    public class FactTable
    {
        ...
        public static void GenerateFacttable(string repoName, int projectSk, int startingBranchSK, int startingBuildPipeLineSK)
        {
            ...
            using (var fileStreamOpened = File.OpenWrite(filepath))
            {
                using (var fileStream = new StreamWriter(fileStreamOpened))
                {
                ...
                fileStreamOpened.Close();
                fileStreamOpened.Dispose();
            }
